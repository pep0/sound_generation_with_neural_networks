...
class LogSpectrogramExtractor:
    ...
    def extract(self, signal):
        stft = librosa.stft(signal, n_fft=self.frame_size, hop_length=self.hop_length)[
            :-1
        ]  # drop one index to get even dim
...
class PreprocessingPipeline:
    """PreprocessingPipeline processes audio files in a directory, applying the following  steps for each step
        1 - load a file
...
if __name__ == "__main__":
    FRAME_SIZE = 512
    HOP_LENGTH = 256
    DURATION = 0.74 # in sec
    SAMPLE_RATE = 22050
    MONO = True

    SPECTROGRAMS_SAVE_DIR = "./save_files/spectrograms/"
    MIN_MAX_VALUE_SAVE_DIR =  "./save_files/min_max_values/"
    FILES_DIR = "./audio_data/free-spoken-digit-dataset/recordings/"
    ...
    saver = Saver(SPECTROGRAMS_SAVE_DIR, MIN_MAX_VALUE_SAVE_DIR)
